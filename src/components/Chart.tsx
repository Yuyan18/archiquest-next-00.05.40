...
const ZoomablePannableCanvas = ({
    ...
    if (canvas && ctx) {
      ...
      features.forEach((feature) => {
        ...
        feature.connections?.forEach((connection) => {
          ...
          ctx.strokeStyle =
            selectedLocation &&
            (feature.id === selectedLocation.id ||
              connection.id === selectedLocation.id)
              ? "red"
              : "gray";
          ctx.stroke();
          ctx.closePath();
  ...
  }, [scale, offset, mapScale, isDragging, dragStart, generating, mouseClick, selectedLocation]);
